<?php
class Woo_Social_Share_Discount_Coupon_Html_output {
    ...
    public static function init($options = array()) {
        ...
        if (!empty($options)) {
        	 ...
        	 echo wp_nonce_field( 'wss_save_option_nonce', 'wss_save_option_nonce_field' );
                ...
                switch ($value['type']) {
                    ...
                    case 'single_select_page' :
                        ...
                        ?><tr valign="top" class="single_select_page">
                            <th scope="row" class="titledesc"><?php echo esc_html($value['title']) ?> <?php echo esc_attr( $tip ); ?></th>
                            <td class="forminp">
    ...
    public static function save_fields($options) {
        if (empty($_POST) || ! isset( $_POST['wss_save_option_nonce_field'] )) {
            return false;
        }

        if ( ! wp_verify_nonce($_POST['wss_save_option_nonce_field'],   'wss_save_option_nonce' ) ) {
        	return false;
        }
        ...
        foreach ($options as $value) {
            ...
            switch (sanitize_title($value['type'])) {
                case 'checkbox' :
                    $option_value = null === $option_value ? 'no' : 'yes';
                    break;
                case 'textarea' :
...
Woo_Social_Share_Discount_Coupon_Html_output::init();
